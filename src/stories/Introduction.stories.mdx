...
import banner from "./assets/chakra-react-select.png";
import checkHighlight from "./assets/check-selected-option.png";
import colorHighlight from "./assets/color-selected-option.png";
import customErrorBorder from "./assets/custom-error-border.png";
import purpleHighlightDark from "./assets/purple-selected-option-dark.png";
import purpleHighlightLight from "./assets/purple-selected-option-light.png";
import stickyGroupHeaders from "./assets/sticky-group-headers.png";
import { colorSchemeOptions } from "./data/data";
import defaultProps from "./data/default-props";
...
<HStack>
  <Link href="https://github.com/csandman/chakra-react-select/blob/main/LICENSE.md">
    <Image
      src="https://badgen.net/github/license/csandman/chakra-react-select"
      alt="MIT License"
    />
  </Link>
  <Link href="https://www.npmjs.com/package/chakra-react-select">
    <Image
      src="https://img.shields.io/npm/v/chakra-react-select"
      alt="NPM Package"
    />
  </Link>
  <Link href="https://bundlephobia.com/result?p=chakra-react-select">
    <Image
      src="https://badgen.net/bundlephobia/min/chakra-react-select"
      alt="Minified Size"
    />
  </Link>
  <Link href="https://bundlephobia.com/result?p=chakra-react-select">
    <Image
      src="https://badgen.net/bundlephobia/minzip/chakra-react-select"
      alt="Min Zipped Size"
    />
  </Link>
  <Link href="https://www.npmjs.com/package/chakra-react-select">
    <Image
      src="https://badgen.net/npm/dt/chakra-react-select?color=blue"
      alt="Total Downloads"
    />
  </Link>
</HStack>
...
<img src={banner} alt="Chakra React Select Banner" />
...
<Canvas>
  <ChakraProvider>
    <VStack spacing={4}>
      ...
      <FormControl id="md">
        <FormLabel>size="md" (default)</FormLabel>
...
<Canvas>
  <ChakraProvider>
    <VStack spacing={4}>
      <FormControl id="global-color">
        <FormLabel>Global Color Scheme</FormLabel>
        <Select {...defaultProps} colorScheme="purple" />
      </FormControl>
      <FormControl id="local-color">
        <FormLabel>Individual Color Schemes</FormLabel>
        <Select {...defaultProps} options={colorSchemeOptions} />
      </FormControl>
    </VStack>
  </ChakraProvider>
</Canvas>
...
<img src={customErrorBorder} alt="Orange errorBorderColor" />
...
<img src={stickyGroupHeaders} alt="Sticky Group Headers" />
...
<img src={colorHighlight} alt="Color Highlighted Selected Option" />

<img src={checkHighlight} alt="Check Highlighted Selected Option" />
...
<img
  src={purpleHighlightLight}
  alt="Purple Selected Option Color (light mode)"
/>

<img src={purpleHighlightDark} alt="Purple Selected Option Color (dark mode)" />
